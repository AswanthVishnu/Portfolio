...
function commander(cmd) {
  switch (cmd.toLowerCase()) {
    ...
    case "medium":
      addLine("Opening Medium.to...", "color2", 80);
      newTab(medium);
      break;
    ...
    case "email":
      addLine(
        'Opening mailto:<a href="mailto:aswanthvishnu.s2021it@sece.ac.in"> aswanthvishnu.s2021it@sece.ac.in</a>...',
        "color2",
        80
      );
      newTab(email);
